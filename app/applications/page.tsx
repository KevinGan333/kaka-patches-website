...
export default function Page() {
  return (
    <main className="bg-white text-slate-900">
      ...
      <section className="bg-blue-600 py-20 text-white"><div className="mx-auto max-w-4xl px-6 text-center"><h2 className="text-3xl font-bold md:text-4xl">Need Custom Patches for Your Application?</h2><p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-blue-50">Tell us about your industry and requirements. We&rsquo;ll recommend the best patch type and prepare a factory-direct quote.</p><div className="mt-10"><Link href="/request-a-quote" className="inline-flex items-center gap-2 rounded-full bg-white px-8 py-3.5 text-sm font-semibold text-blue-700 shadow-lg transition hover:bg-blue-50">Request a Quote →</Link></div></div></section>
    </main>
  );
}
